...
resource "google_cloud_run_service_iam_member" "noauth" {
  location = google_cloud_run_service.api_blockchain.location
  project  = google_cloud_run_service.api_blockchain.project
  service  = google_cloud_run_service.api_blockchain.name
  role     = "roles/run.invoker"
  member   = "allUsers"

  depends_on = [google_cloud_run_service.api_blockchain]
}